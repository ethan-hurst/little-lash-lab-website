...
import Img6 from "../../assets/images/logo/Unsplash_pics/hannah-olinger-549280-unsplash.jpg"
    ...
    return (
      <React.Fragment>
        ...
        <_Post
          ...
          img={Img4}
          alt="lashing will make you feel sleepy"
        />
        <_Post
          ...
          img={Img5}
          alt="close up eye lash"
        />
        <_Post
          header="A Note From The lasher"
          paragraph={
            <div>
              <p>
                Here are a collection of articles that I've found really helpful
                for the process. You're welcome to have a read of these too
              </p>
              <ul>
                <li>
                  <a href="https://intothegloss.com/2016/07/eyelash-extensions-pros-and-cons/">
                    Six things you need to know about eyelash extensions
                  </a>
                </li>
                <li>
                  <a href="https://www.instyle.com/beauty/eyelash-extensions-pros-and-cons">
                    The Pros and Cons of Eyelash extensions
                  </a>
                </li>
                <li>
                  <a href="http://www.thecut.com/article/guide-to-eyelash-extensions.html">
                    A Guide to eyelash extensions
                  </a>
                </li>
                <li>
                  <a href="https://www.refinery29.com/2018/08/207626/eyelash-extensions-pros-and-cons">
